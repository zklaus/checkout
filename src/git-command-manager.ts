...
export interface IGitCommandManager {
  ...
  submoduleUpdate(fetchDepth: number, recursive: boolean, filter?: string): Promise<void>
...
class GitCommandManager {
  ...
  async submoduleUpdate(fetchDepth: number, recursive: boolean, filter?: string): Promise<void> {
